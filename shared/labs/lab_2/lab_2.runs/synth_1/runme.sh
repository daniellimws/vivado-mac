...
HD_PWD='/home/osboxes/lab_2/lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log six_bit_subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source six_bit_subtractor.tcl
